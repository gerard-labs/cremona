      ...
      <section class="theme-error-shell__panel">
        <div class="theme-empty" data-size="lg" role="region" aria-labelledby="${titleId}">
          ...
          <div class="theme-empty__content">
            <h1 id="${titleId}" class="theme-empty__title">${t('theme.error.coming-soon.title')}</h1>
            <div class="theme-empty__body"><p>${t('theme.error.coming-soon.body')}</p></div>
            <div class="theme-empty__actions">
              <a class="theme-button" data-variant="primary" data-size="md" href="#subscribe"><span class="theme-button__label">${t('theme.error.coming-soon.primary-cta')}</span></a>
              ${secondaryHtml}
            </div>
          </div>
        </div>
...
const bodyHtml = `
  <section class="error-cs-story" data-testid="error-cs-root">
    ...
    <section class="error-cs-story__section" aria-labelledby="error-cs-section-default">
      <h2 id="error-cs-section-default" class="theme-typography" data-variant="overline" data-color="tertiary">${t('theme.error.coming-soon.story.section.default')}</h2>
      <p class="error-cs-story__explainer theme-typography" data-variant="caption" data-color="tertiary">${t('theme.error.coming-soon.story.explainer.default')}</p>
    ...
    <section class="error-cs-story__section" aria-labelledby="error-cs-section-with-back">
      <h2 id="error-cs-section-with-back" class="theme-typography" data-variant="overline" data-color="tertiary">${t('theme.error.coming-soon.story.section.with-back')}</h2>
      <p class="error-cs-story__explainer theme-typography" data-variant="caption" data-color="tertiary">${t('theme.error.coming-soon.story.explainer.with-back')}</p>
...
<template>
  <Story title="Patterns/Error-ComingSoon" group="Ring 3" :layout="{ type: 'single' }">
...
.error-cs-story__frame .theme-error-shell { min-block-size: 100%; }
